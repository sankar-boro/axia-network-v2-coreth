...
go build -ldflags "-X github.com/sankar-boro/axia-network-v2-coreth/plugin/evm.GitCommit=$coreth_commit -X github.com/sankar-boro/axia-network-v2-coreth/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
